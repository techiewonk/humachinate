...
module_dir = os.path.join(__location__, "../src/humachinate")
try:
...
project = "humachinate"
copyright = "2024, Hemprasad Badgujar"
...
try:
    from humachinate import __version__ as version
except ImportError:
    version = ""
...
htmlhelp_basename = "humachinate-doc"
...
latex_documents = [
    ("index", "user_guide.tex", "humachinate Documentation", "Hemprasad Badgujar", "manual")
]
